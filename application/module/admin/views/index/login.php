            ...
            <div class="card-body">
                ...
                <form action="<?php echo $linkAction; ?>" method="post" id="form-login">
                    <div class="input-group mb-3">
                        <input type="text" name="form[username]" class="form-control" placeholder="User Name">
                    ...
                    <div class="row">
                        ...
                        <!-- /.col -->
                        <div class="col-4">
                            <button type="submit" class="btn btn-primary btn-block" onclick="document.getElementById('form-login').submit();">Sign In</button>
                        </div>
                        <!-- /.col -->
                    </div>
                </form>
