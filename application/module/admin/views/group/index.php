...
$selectboxGroupACP  = Helper::cmsSelectBox('filter_group_acp', 'inputbox', $arrGroupACP, $this->arrParam['filter_group_acp'], 'margin-left: 10px;height:35px;');
                        ...
                        <form action="#" method="post" name="adminForm" id="adminForm">
                            ...
                            <thead>
                                <tr role="row">
                                    ...
                                    <th style="width: 34px;"><?php echo $lblGroupACP; ?></th>
                            ...
                            <tbody>
                                ...
                                ?>
                                        <tr class="<?php echo $row; ?>">
                                            ...
                                            <td class=" "><?php echo $group_acp; ?></td>
