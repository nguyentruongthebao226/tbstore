...
class Model
{
	...
	public function __construct($params = null)
	{
		...
		if (!$link) {
			die('Fail connect: ' . mysqli_connect_errno($link));
	...
	public function highlightText($word,$text){
		$modifiedrawData = preg_replace('/'.$word.'/i', '<mark>$0</mark>', $text);
		return $modifiedrawData;
	}
}